...
| `preview_skill_import` | LOW | Auto | Parse and validate a pasted Skill without saving it. |
| `save_skill_draft` | DEVICE_CONTROL | Require approval | Save a pasted Skill as a disabled draft. |
| `enable_skill` | DEVICE_CONTROL | Require approval | Enable a valid user Skill. |
| `disable_skill` | DEVICE_CONTROL | Require approval | Disable a user Skill. |
| `list_skills` | SENSITIVE_READ | Require approval | List Skill metadata and status. |
