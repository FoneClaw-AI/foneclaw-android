...
| `mail_list` | LOW | Auto | List, filter, or search message summaries. Query searches subject, sender, recipients, and body. Leave accountId empty to use the only account or the unique default account. |
