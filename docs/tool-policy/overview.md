...
For the complete public list of tool names, risks, and Skill authoring notes, see
[Built-in Tool Catalog](tool-catalog.md).
...
- Status reads: `bluetooth_state`, `flashlight_status`, `volume_status`, `dnd_status`, `system_settings_status`
...
- Wi-Fi: `wifi_set_enabled`, `wifi_connect`, `wifi_disconnect`
- Volume: `volume_set_stream`, `volume_adjust_stream`, `volume_set_stream_muted`, `volume_set_ringer_mode`
- Bluetooth: `bluetooth_pair_device`, `open_bluetooth`, `close_bluetooth`
...
- Memos: `memo_create`, `memo_update`, `memo_mark_done`
