...
2. Check the [Built-in Tool Catalog](docs/tool-policy/tool-catalog.md) for exact tool names, risk levels, and approval behavior
3. Copy the [skill template](skills/_template/SKILL.md)
4. Create your skill under `skills/your-skill-name/SKILL.md`
5. Test it on your FoneClaw installation by pasting `SKILL.md` into Home or using a one-click import link
...
- [ ] Available tools are listed with descriptions and match the [Tool Catalog](docs/tool-policy/tool-catalog.md)
- [ ] Workflows are step-by-step and reference real tool names
- [ ] Risky, external-effect, and destructive tools include clear confirmation and failure behavior
...
- [ ] `steps` reference valid tool names from the [Tool Catalog](docs/tool-policy/tool-catalog.md)
...
- Link to the [Tool Catalog](docs/tool-policy/tool-catalog.md) when a Skill relies on less common tools
